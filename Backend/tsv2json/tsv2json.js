...
const getProductUrlFromLineItem = (fields, header) => {
  try {
    ...
    err_log += " Error in parsing getting url";
    return ''
  }
}
...
const getPriceFromSales = (fields, header) => {
  try {
    ...
    err_log += " Error in parsing getPriceFromSales";
    return NaN;
  }
}
...
const orderDateToISODate = (orderDate) => {
  try {
    ...
    err_log += " Error in parsing OrderDateToISODate";
    return '';
  }
}
...
const getISOOrderDateIfAfter = (fields, header, dateString) => {
  ...
  try {
    ...
    err_log += " Error in parsing getISOOrderDateIfAfter";
    return null;
  }
}
